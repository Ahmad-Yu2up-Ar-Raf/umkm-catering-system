...
**Business:** Catering Nusantara (Dapur Bunda Catering), Bogor, since 2019. Hybrid catalog: 5 catering packages (Nasi Box, Prasmanan Pernikahan, Snack Box, Tumpeng Mini, Prasmanan Korporat) → converted via WhatsApp.
