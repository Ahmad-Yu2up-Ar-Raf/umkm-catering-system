...
- **Status skema:** Graph menunjukkan `paket` migration/model/seeder **belum dibuat** (hanya users/cache/jobs/personal_access_tokens). DatabaseSeeder ada di `backend/database/seeders/DatabaseSeeder.php`.
