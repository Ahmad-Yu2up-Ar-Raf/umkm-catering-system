    ...
    return (
      <Tag
        ...
        className={cn(
          ...
          "group hover:text-pr relative flex cursor-pointer items-center gap-1 overflow-hidden rounded-[100px] border-[1.5px] border-primary bg-transparent px-9 py-6 text-sm font-semibold text-primary transition-all duration-[600ms] ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-transparent active:scale-[0.95] hover:text-primary-foreground",
