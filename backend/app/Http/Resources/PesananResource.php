...
class PesananResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'tanggal_acara' => $this->tanggal_acara ? \Carbon\Carbon::parse($this->tanggal_acara)->toDateString() : null,
            'harga_paket_satuan' => $this->harga_paket_satuan,
            'detail_tambahan' => $this->detail_tambahan,
            // menu_tambahan persisted inside detail_tambahan JSON or separate — expose if column exists
            'menu_tambahan' => $this->menu_tambahan ?? null,
            'biaya_tambahan' => $this->biaya_tambahan,
            'catatan' => $this->catatan,
            'total_harga' => $this->total_harga,
            'status_pesanan' => $this->status_pesanan?->value ?? $this->status_pesanan,
            'metode_pembayaran' => $this->metode_pembayaran?->value ?? $this->metode_pembayaran,
